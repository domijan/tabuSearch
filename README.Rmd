...
You can install the development version of tabuSearch from [GitHub](https://github.com/) with:
...
An example for how it works. We'll simulate 10-d data: 150 samples from 3 bivariate normals and 8 noise variables. 
